...
const AboutUs: React.FC = () => {
  ...
  const [aboutUsData, setAboutUsData] = useState<JsonApiDataAttributes | null>(
    null
  );
    ...
    <Container fluid className="p-0">
        ...
        <Row>
          <Col md={6}>
            <Image
              ...
              alt={field_image_url[0].title}
              fluid
            />
          </Col>
          <Col md={6} className="d-flex justify-content-end p-4 text-start">
            <div>
              <h2 className="fw-light">{field_paragraph[0]}</h2>
              <p className="pt-2">
      ...
      <Container fluid className="bg-black text-light">
        <Row fluid className="py-5 pb-4 p-5">
          ...
          <h2
            style={{ position: "relative", color: "red", marginRight: "10rem" }}
      ...
      <Container className="my-4 p-5">
        <h2 className="text-danger py-5">{field_heading[2].split(".")[0]}</h2>
        ...
        <Row>
          ...
          <Col md={6} className="p-5 d-flex align-items-center">
            <div>
              <h3>
                <b>
                  {field_paragraph_title[0].split("flexible cooperation")[0]}
                </b>
                <i>flexible cooperation</i>
              </h3>
              <p>{field_paragraph_description[1]}</p>
              <h3>
        ...
        <Row>
          <Col md={6} className="mb-5">
            ...
            <p>{field_paragraph_description[3]}</p>
            <h3>
              <b>Big picture.</b> Small details.
            </h3>
            <p>{field_paragraph_description[4]}</p>
          </Col>
        </Row>
      </Container>
    </Container>
