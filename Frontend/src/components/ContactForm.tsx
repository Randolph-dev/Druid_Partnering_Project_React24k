    ...
    <Container fluid className="py-5 d-flex flex-column align-items-center" style={{ height: '1000px', padding: 0 }}>
      ...
      */}
      ...
      >
        ...
        >
          <div className="mauticform-error" id="mauticform_contactformclient_error"></div>
          <div className="mauticform-message" id="mauticform_contactformclient_message"></div>
          <div className="mauticform-innerform">
            ...
            >
              <Form.Group id="mauticform_contactformclient_first_name" className="mauticform-row mauticform-text mauticform-field-1">
                <Form.Label
                  id="mauticform_label_contactformclient_first_name"
              ...
              <Form.Group id="mauticform_contactformclient_last_name" className="mauticform-row mauticform-text mauticform-field-2">
                <Form.Label
                  id="mauticform_label_contactformclient_last_name"
          ...
          <input type="hidden" name="mauticform[formId]" id="mauticform_contactformclient_id" value={formId[currentFormType]} />
